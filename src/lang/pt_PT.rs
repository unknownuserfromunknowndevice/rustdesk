...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "A conectar ao servidor do HushDesk..."),
        ("Enable service", "Ativar Serviço"),
        ("Start service", "Iniciar Serviço"),
        ("Service is running", "Serviço está activo"),
        ("Service is not running", "Serviço está desativado"),
        ("not_ready_status", "Indisponível. Por favor verifique a sua conexão"),
        ...
        ("install_tip", "Devido ao UAC, o HushDesk não funciona correctamente em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o HushDesk no sistema."),
        ...
        ("config_acc", "Para controlar o seu Ambiente de Trabalho remotamente, é preciso conceder ao HushDesk permissões de \"Acessibilidade\"."),
        ("config_screen", "Para aceder ao seu Ambiente de Trabalho remotamente, é preciso conceder ao HushDesk permissões de \"Gravar a Tela\"/"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle o seu dispositivo Android via rato ou toque, você precisa permitir que o HushDesk use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], ACTIVE o serviço [HushDesk Input]."),
        ...
        ("Language", "Linguagem"),
        ("Keep RustDesk background service", "Manter o serviço HushDesk em funcionamento"),
