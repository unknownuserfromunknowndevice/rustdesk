...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("desk_tip", "O seu computador pode ser acessado com este ID e password."),
        ("Password", "password"),
        ("Ready", "Pronto"),
        ("Established", "Estabelecido"),
        ("connecting_status", "Conectando à rede do HushDesk..."),
        ...
        ("Control Remote Desktop", "Introduzir o ID do HushDesk"),
        ...
        ("Remove", "Remover"),
        ("Refresh random password", "Atualizar password aleatória"),
        ("Set your own password", "Configure sua própria password"),
        ...
        ("Website", "Website"),
        ("About", "Sobre"),
        ("Slogan_tip", "Direção de Sistemas e Redes - Grupo ACIN!"),
        ...
        ("OK", "OK"),
        ("Password Required", "Password necessária"),
        ("Please enter your password", "Por favor informe sua password"),
        ...
        ("OS Password", "Password do SO"),
        ("install_tip", "Devido ao UAC, o HushDesk não funciona corretamente como o lado remoto em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o HushDesk no sistema."),
        ...
        ("config_acc", "Para controlar seu computador remotamente, você precisa conceder ao HushDesk permissões de \"Acessibilidade\"."),
        ("config_screen", "Para acessar seu computador remotamente, você precisa conceder ao HushDesk permissões de \"Gravar a Tela\"/"),
        ...
        ("Enter your password", "Informe sua password"),
        ...
        ("Username missed", "Nome de utilizador requerido"),
        ("Password missed", "Password requerida"),
        ("Wrong credentials", "Nome de utilizador ou password incorretos"),
        ("The verification code is incorrect or has expired", ""),
        ("Edit Tag", "Editar Tag"),
        ("Forget Password", "Esquecer Password"),
        ("Favorites", "Favoritos"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle seu dispositivo Android via mouse ou toque, você precisa permitir que o HushDesk use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], HABILITE o serviço [HushDesk Input]."),
        ...
        ("Language", "Idioma"),
        ("Keep RustDesk background service", "Manter o serviço do HushDesk executando em segundo plano"),
        ...
        ("Use permanent password", "Utilizar password permanente"),
        ("Use both passwords", "Utilizar ambas as passwords"),
        ("Set permanent password", "Configurar password permanente"),
        ...
        ("remote_restarting_tip", "O dispositivo remoto está reiniciando, feche esta caixa de mensagem e reconecte com a password permanente depois de um tempo"),
        ("Copied", "Copiado"),
        ...
        ("elevated_foreground_window_tip", "A janela atual da área de trabalho remota requer privilégios mais altos para operar, portanto, não é possível usar o mouse e o teclado temporariamente. Você pode solicitar ao utilizador remoto para minimizar a janela atual ou clicar no botão de elevação na janela de gerenciamento de conexão. Para evitar esse problema, é recomendável instalar o software no dispositivo remoto."),
        ...
        ("Show RustDesk", "Exibir HushDesk"),
        ("This PC", "Este Computador"),
        ("or", "ou"),
        ("Continue with", "Continuar com"),
        ("Elevate", "Elevar"),
        ("Zoom cursor", "Aumentar cursor"),
        ("Accept sessions via password", "Aceitar sessões via password"),
        ...
        ("One-time Password", "Password de uso único"),
        ("Use one-time password", "Usar password de uso único"),
        ("One-time password length", "Comprimento da password de uso único"),
        ...
        ("hide_cm_tip", "Permitir ocultação somente se aceitar sessões via password e usar password permanente"),
        ...
        ("config_input", "Para controlar a área de trabalho remota com teclado, você precisa conceder a permissão \"Monitoramento de entrada\" do HushDesk."),
        ("config_microphone", "Para falar remotamente, você precisa conceder a permissão \"Gravar áudio\" do HushDesk."),
        ...
        ("Ask the remote user for authentication", "Peça autenticação ao utilizador remoto"),
        ("Choose this if the remote account is administrator", "Escolha isto se a conta remota for administrador"),
        ("Transmit the username and password of administrator", "Transmita o nome de utilizador e a password do administrador"),
        ("still_click_uac_tip", "Ainda requer que o utilizador remoto clique em OK na janela UAC da execução do HushDesk."),
        ("Request Elevation", "Pedir Elevação"),
        ("wait_accept_uac_tip", "Aguarde até que o utilizador remoto aceite a caixa de diálogo do UAC."),
        ...
        ("Set one-time password length", "Definir comprimento de password descartável"),
        ...
        ("empty_favorite_tip", "Ainda não há conexões recentes?\nVamos verificar algum equipamento para se conectar e adicioná-lo aos seus favoritos!"),
        ("empty_lan_tip", "Ainda não foi detectado nenhum equipamento com o HushDesk instalado na rede."),
        ...
        ("verify_rustdesk_password_tip", "Verifique a password do HushDesk"),
        ...
        ("another_user_login_title_tip", "Outro utilizador já está conectado"),
        ...
        ("Refresh Password", "Atualizar password"),
        ("ID", "ID"),
        ...
        ("scam_text1", "Se você estiver ao telefone com alguém que NÃO conhece e em quem NÃO confia e essa pessoa pedir para você usar o HushDesk e iniciar o serviço, NÃO faça isso !! e desligue imediatamente."),
        ...
        ("auto_disconnect_option_tip", "Encerrar sessões entrantes automaticamente por inatividade do utilizador."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Atualize o HushDesk Server Pro para a versão {} ou superior."),
        ...
        ("selinux_tip", "O SELinux está ativado em seu dispositivo, o que pode impedir que o HushDesk funcione corretamente como dispositivo controlado."),
        ...
        ("Enable blocking user input", "Habilitar bloqueio da entrada do utilizador"),
        ...
        ("powered_by_me", "Desenvolvido por HushDesk"),
        ...
        ("preset_password_warning", "Atenção: esta edição personalizada vem com uma password predefinida. Qualquer pessoa que a conhecer poderá controlar totalmente seu dispositivo. Se isso não for o que você deseja, desinstale o software imediatamente."),
        ("Security Alert", "Alerta de Segurança"),
        ("My address book", "Minha lista de contatos"),
        ("Personal", ""),
        ("Owner", "Proprietário"),
        ("Set shared password", "Definir password compartilhada"),
        ("Exist in", ""),
        ...
        ("allow-only-conn-window-open-tip", "Permitir conexões apenas quando a janela do HushDesk estiver aberta"),
        ...
        ("floating_window_tip", "Ajuda a manter o serviço HushDesk em segundo plano"),
