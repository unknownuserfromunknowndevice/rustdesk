...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Wrong credentials", "Nome de usuário ou password incorretos"),
        ...
        ("Transmit the username and password of administrator", "Transmita o nome de usuário e a password do administrador"),
        ("still_click_uac_tip", "Ainda requer que o usuário remoto clique em OK na janela UAC da execução do HushDesk."),
        ...
        ("empty_recent_tip", "Ops, não há sessões recentes!\nHora de realizar uma nova."),
        ("empty_favorite_tip", "Ainda não há equipamentos favoritos?\nVamos encontrar algum equipamento para se conectar e adicioná-lo aos seus favoritos!"),
        ("empty_lan_tip", "Parece que ainda não descobrimos nenhum parceiro."),
        ("empty_address_book_tip", "Parece que atualmente não há equipamentos listados em seu catálogo de endereços."),
        ("eg: admin", "ex. admin"),
        ...
        ("outgoing_only_desk_tip", "HushDesk\nEsta aplicação apenas pode conectar-se a equipamentos autorizados, sendo que outros, não podem conectar-se ao seu."),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Atualize o cliente HushDesk para a versão {} ou superior no lado remoto."),
